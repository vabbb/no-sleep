...
$(konsole --noclose -e "ssh -t vabbb@${HOST} 'cd pcaps && sudo tcpdump -i ens3 -G 20 -z ./rm_old_and_mv_to_done.py -w dump_%Y-%m-%d_%H:%M:%S.pcap tcp port 8080 or 443 or 80 or 9876 or not 22'") &